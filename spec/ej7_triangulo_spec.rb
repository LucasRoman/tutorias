...
begin
  ...
  puts <<-INSTRUCTIONS
    ...
    Para eso hacer una clase triangulo que reciba los 3 números en el initializer e implementar el método valid? que 
    retorne true o false dependiendo si es o no un triángulo.
...
describe '#triangulo' do
  ...
  it 'triangulo valid should be false when sizes are 1, 2 and 8' do
    expect(Triangulo.new(4, 5, 6).valid?).to eq true
  end
